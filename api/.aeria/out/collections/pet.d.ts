...
export declare type petCollection = {description: {$id: "pet",properties: {name: {type: "string"},owner: {type: "array",items: {$ref: "person"}},age: {type: "integer"},type: {enum: ["Mammal","Bird","Reptile","Fish","Invertebrate"]},picture: {$ref: "file",accept: ["image/*"]}},icon: "dog",presets: ["crud"],indexes: ["name","owner","age"]},functions: {get: typeof get,getAll: typeof getAll,insert: typeof insert,upload: typeof upload,remove: typeof remove},exposedFunctions: {get: true,getAll: true,insert: true,upload: true,remove: true}}
