...
export declare type petCollection = {description: {$id: "pet",properties: {name: {type: "string"},type: {enum: ["Mammal","Bird","Reptile","Fish","Invertebrate"]},age: {type: "string"},owner: {type: "array",items: {$ref: "person"}},picture: {$ref: "file",accept: ["image/*"]}},icon: "dog",presets: ["crud"],indexes: ["name","age","owner"]},functions: {get: typeof get,getAll: typeof getAll,insert: typeof insert,upload: typeof upload},exposedFunctions: {get: true,getAll: true,insert: true,upload: true}}
