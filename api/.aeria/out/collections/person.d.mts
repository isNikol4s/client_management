...
export declare type personCollection = {description: {$id: "person",properties: {name: {type: "string"},document: {type: "string"},email: {type: "string"},phone: {type: "string"}},icon: "person",presets: ["crud"],indexes: ["name","document","email","phone"]},functions: {get: typeof get,getAll: typeof getAll,insert: typeof insert},exposedFunctions: {get: true,getAll: true,insert: true}}
